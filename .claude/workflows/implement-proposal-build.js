...
export const meta = {
  ...
  phases: [
    ...
    { title: "Verify", detail: "run the reached test levels and the staged manual-validation scenarios, fixing until green and coverage meets the floor" },
