...
// registry state rejects with this single code, and the §6.3.1 SCIM
// receiver is the one endpoint outside that set. The spec defines no
// separate config-rejection code.
