...
// skills (the plugin format has no native component for them). The
// repository-root marketplace.json that lists the plugins is generated by a
// separate step (it aggregates an array across artifacts).
