...
test-live-external:
	...
	PODIUM_PINECONE_SELFEMBED_INDEX="$$PODIUM_PINECONE_SELFEMBED_INDEX" \
	...
	PODIUM_WEAVIATE_SELFEMBED_COLLECTION="$$PODIUM_WEAVIATE_SELFEMBED_COLLECTION" \
	...
	PODIUM_QDRANT_SELFEMBED_COLLECTION="$$PODIUM_QDRANT_SELFEMBED_COLLECTION" \
